            ...
            <div className="flex flex-col justify-between min-h-[400px] mt-5 border border-solid border-[#A9A9A9] rounded-xl p-3">
              ...
              <div className="flex flex-col items-end w-full">
                ...
                <button
                  ...
                  className="flex flex-row justify-center items-center gap-2 min-w-[200px] mt-6 rounded-xl p-4 text-white font-medium font-robotoMedium text-sm button-gradient"
                >
