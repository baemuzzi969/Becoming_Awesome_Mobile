          ...
          <div className="bg-white mt-6 rounded-t-3xl px-6 h-full">
            ...
            <div className="mt-6">
              <label className="flex items-center justify-between py-4 border-t border-[#A9A9A9] cursor-pointer">
                <div>
                  <div className="text-sm font-bold font-robotoBold text-[#282828]">
                    Free
                  </div>
                </div>
              ...
              <div className="border-t border-[#A9A9A9] py-4">
                ...
                <div className="text-xs font-normal font-robotoNormal text-[#585858] leading-5">
              ...
              <div className="border-t border-[#A9A9A9] py-4">
                ...
                <div className="text-sm font-normal font-robotoNormal text-[#282828]">
                  Full access to all features for one month
                </div>

                <div className="mt-3 text-xs font-normal font-robotoNormal text-[#585858] leading-5">
              ...
              <div className="py-12">
                <button
                  ...
                  className="w-full rounded-xl p-4 text-white font-medium font-robotoMedium text-sm button-gradient"
                >
                  {ctaText()}
                </button>
              </div>
